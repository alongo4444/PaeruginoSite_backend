...
def check_spacing_zero():
    """
    check the spacing internal function
    """
    assert strains.get_offset(0) in str(2)


def check_spacing_positive():
    """
    check the spacing internal function
    """
    assert strains.get_offset(300) in str(0.001162 * 300 + 0.311)


def check_font_size_zero():
    """
...
def check_first_layer_offset_zero():
    """
...
def check_first_layer_offset_bigger():
    """
    check the first layer offset internal function
    """
...
def check_first_layer_offset_positive():
    """
    check the first layer offset internal function
    """
