...
async def cluster_tree(
    ...
    subtreeSort, list_strains, filename, command = preprocess_cluster(db,list_strain_gene,subtree,MLST)
    ...
    # Execute R query
    try:
        p = subprocess.Popen([command, '--vanilla', os.path.abspath("static/cluster/" + filename + ".R")],
